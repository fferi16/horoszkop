...
window.HDATA.chrono = {
  ...
  moon: {
    ...
    phases: [
      ...
      { key: 'novekvo_sarlo', name: 'Növekvő sarló', symbol: '🌒', from: 22.5, to: 67.5,
      ...
      { key: 'elso_negyed', name: 'Első negyed', symbol: '🌓', from: 67.5, to: 112.5,
      ...
      { key: 'novekvo_dombor', name: 'Növekvő domború', symbol: '🌔', from: 112.5, to: 157.5,
      ...
      { key: 'fogyo_dombor', name: 'Fogyó domború', symbol: '🌖', from: 202.5, to: 247.5,
      ...
      { key: 'utolso_negyed', name: 'Utolsó negyed', symbol: '🌗', from: 247.5, to: 292.5,
      ...
      { key: 'fogyo_sarlo', name: 'Fogyó sarló', symbol: '🌘', from: 292.5, to: 337.5,
